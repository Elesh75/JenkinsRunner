...
To create three EC2 instances named "Sonar," "Nexus," and "Ansible" in the us-east-1 region using Terraform, and bootstrap the "Ansible" instance with a user_data script, you can modify your existing Terraform configuration as follows:
